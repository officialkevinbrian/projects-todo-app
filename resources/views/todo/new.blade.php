...
<div class="p-3 gap-3 flex flex-col flex-1 ">
    <div class="gap-3 flex flex-col">
        <a href="/todos" class=" w-10 h-10  self-start border p-1 rounded-full text-center flex flex-col justify-center items-center">
    ...
    <div class=" flex flex-col gap-3 flex-1 ">
        ...
        <input class="border rounded-full p-2" placeholder="Coloque o titulo da sua tarefa aqui!" />
        <input placeholder="Descricao (opcional)" class="border rounded-full p-2" />
